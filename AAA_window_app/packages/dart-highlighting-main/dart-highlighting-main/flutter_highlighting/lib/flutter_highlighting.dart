...
/// Highlight Flutter Widget with text selection support
class HighlightView extends StatelessWidget {
  ...
  static const _defaultFontColor = Color(0xffffffff);
  static const _defaultBackgroundColor = Color(0xff272822);
    ...
    return Container(
      ...
      child: Text.rich(
        TextSpan(
          style: _textStyle,
          children: _convert(
            highlight.parse(source, languageId: languageId ?? '').nodes ?? [],
          ),
        ),
      ),
    );
